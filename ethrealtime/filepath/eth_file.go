...
const (
	...
	//BlockChainPath     string = "/meta/ethfile/blockdata"
	//BlockChainLogsPath string = "/meta/ethfile/erctokendata"
	//BlockChainDataPath string = "/meta/ethfile/blockdata/"
	//BlockChainAddressPath  string = "/meta/ethfile/addressdata"
)
